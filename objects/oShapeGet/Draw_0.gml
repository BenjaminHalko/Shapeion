...
if(percent >= 1) {
	if(correct and instance_exists(oPlayer)) {
		...
		if os_type == os_android and global.score < 10000 and (global.score + points) % 1000 < global.score % points {
			GooglePlayServices_Achievements_Unlock(global.achievementID[global.hardMode][global.score div 1000]);
		}
		global.score += points;
