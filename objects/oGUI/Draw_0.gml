...
if(oGlobalController.title) {
	draw_text(room_width/3,yMin+lerp(12,-32,1-oGlobalController.titleAlpha),"NORMAL HI-SCORE\n  "+string_replace_all(string_format(global.hiScore[0],5,0)," ","0"));
	draw_text(room_width/3*2,yMin+lerp(12,-32,1-oGlobalController.titleAlpha),"HARD HI-SCORE\n"+string_replace_all(string_format(global.hiScore[1],5,0)," ","0"));
}

if(oGlobalController.titleAlpha != 1) {
	draw_set_halign(fa_left);
	draw_text(64,yMin+lerp(12,-32,oGlobalController.titleAlpha),"SCORE\n  "+string_replace_all(string_format(global.score,4,0)," ","0"));
	draw_set_halign(fa_center);	
	draw_text(room_width/2,yMin+lerp(12,-32,oGlobalController.titleAlpha),"HIGH SCORE\n"+string_replace_all(string_format(global.hiScore[hiScoreView],5,0)," ","0"));
