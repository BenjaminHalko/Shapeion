...
draw_surface_ext(surface,room_width*max(0,1-z)/2,room_height*max(0,1-z)/2,min(1,z),min(1,z),0,merge_color(c_black,c_white,min(1,z*2)),min(1,(0.1-max(0,z-1))/0.1));

draw_set_alpha(min(1,(0.1-max(0,z-1))/0.1));
for(var j = 0; j < array_length(shapes); j++) {
